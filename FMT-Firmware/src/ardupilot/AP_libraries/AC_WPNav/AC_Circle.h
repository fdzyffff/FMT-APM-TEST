...
#define AC_CIRCLE_RADIUS_DEFAULT    500.0f     // radius of the circle in cm that the vehicle will fly
#define AC_CIRCLE_RATE_DEFAULT      15.0f       // turn rate in deg/sec.  Positive to turn clockwise, negative for counter clockwise
...
public:
    ...
    // parameters
    float    _radius;        //para // maximum horizontal speed in cm/s during missions
    float    _rate;          //para // rotation speed in deg/sec
