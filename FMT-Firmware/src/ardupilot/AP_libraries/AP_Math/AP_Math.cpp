...
T apm_constrain_value(const T amt, const T low, const T high)
{
    ...
    // errors through any function that uses apm_constrain_value(). The normal
...
template int apm_constrain_value<int>(const int amt, const int low, const int high);
template short apm_constrain_value<short>(const short amt, const short low, const short high);
template float apm_constrain_value<float>(const float amt, const float low, const float high);
template double apm_constrain_value<double>(const double amt, const double low, const double high);
