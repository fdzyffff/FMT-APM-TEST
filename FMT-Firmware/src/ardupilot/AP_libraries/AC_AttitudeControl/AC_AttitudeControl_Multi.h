...
public:
    ...
    AC_PID                _pid_rate_roll;//para
    AC_PID                _pid_rate_pitch;//para
    AC_PID                _pid_rate_yaw;//para
    
    float              _thr_mix_man; //para     // throttle vs attitude control prioritisation used when using manual throttle (higher values mean we prioritise attitude control over throttle)
    float              _thr_mix_min; //para     // throttle vs attitude control prioritisation used when landing (higher values mean we prioritise attitude control over throttle)
    float              _thr_mix_max; //para     // throttle vs attitude control prioritisation used during active flight (higher values mean we prioritise attitude control over throttle)
